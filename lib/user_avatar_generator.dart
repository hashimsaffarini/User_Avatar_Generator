...
class UserAvatarGenerator extends StatelessWidget {
  ...
  const UserAvatarGenerator({
    ...
    this.border, // Simplified border property
    this.textSize,
    this.textAlignment = Alignment.center,
    this.isUpperCase = true, // Default to uppercase
    this.numberOfCharacters = 2, // Default to 2 characters for initials
  });
  ...
  String generateInitials(String fullName,
    ...
    List<String> names = fullName
        .trim()
        .split(RegExp(r'\s+')); // Split by any amount of whitespace
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        shape: avatarShape,
        border: border, // Use the simplified border property
      ),
      child: Align(
